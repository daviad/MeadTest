...
typedef enum
{
    SDWebImageRetryFailed = 1 << 0,          // Not supported
    SDWebImageLowPriority = 1 << 1,          // Not supported
    SDWebImageCacheMemoryOnly = 1 << 2,      // Not supported
    SDWebImageProgressiveDownload = 1 << 3,  // Not supported
    SDWebImageAsyncLoadFromDisk = 1 << 4,    // Load image from disk then decoding in background thread
    SDWebImageProgressRated = 1 << 5,        // Progress tracked
    SDWebImageThumbnail = 1 << 6             // Get thumbnail (Only support library photos)
} SDWebImageOptions;
 ...
 *                   failure:nil];
 */
@interface SDWebImageManager : NSObject </*SDWebImageDownloaderDelegate, */SDImageCacheDelegate, ASIProgressDelegate>
{
