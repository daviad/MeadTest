...
- (void)drawImage:(CGRect)rect {
 //去去图片
//    NSLog(@"xx_imageNode.URL:%@",_imageNode.URL);
//    NSLog(@"yy_imageNode.image:%@",_imageNode.image);
//    NSLog(@"zz_imageFrame:%@",NSStringFromCGRect(rect));
    ...
    {
        [(TTStyledTextLabel*)self.whichLable   refreshPartWithFrame:self];
