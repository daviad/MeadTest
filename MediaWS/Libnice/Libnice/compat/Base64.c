...
#define CR_LF_SIZE 2
	...
	* BASE64_UNIT_SIZE;
	...
	//
	UInt8 *outputBuffer = (UInt8 *)malloc(outputBufferSize);
	if (!outputBuffer)
	{
		return NULL;
	}
...
{
	return CompatBase64Decode(inputBuffer, strlen(inputBuffer), outputLength);
}
